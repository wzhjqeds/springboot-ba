...
public class MPGenerator {
	...
	private static final String moduleName = MPGenerator.class.getPackage().getName()
			.substring(MPGenerator.class.getPackage().getName().lastIndexOf(".") + 1);

	private static final String[] tablePrefix = new String[] {};

	private static final String[] tableInclude = new String[] { "sys_user" };

	private static final String jdbcUrl = "jdbc:mysql://localhost:3306/demo_sys";

	private static final String jdbcUsername = "root";

	private static final String jdbcPassword = "rootroot";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		gc.setEnableCache(false);// XML 禁用二级缓存
